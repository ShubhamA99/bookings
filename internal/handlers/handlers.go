...
func (m *Repository) Reservation(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		// return
		m.App.Session.Put(r.Context(), "error", "cant find the room")
		http.Redirect(w, r, "/", http.StatusTemporaryRedirect)
		return
	}
...
func (m *Repository) PostReservation(w http.ResponseWriter, r *http.Request) {
	...
	reservation.CommitteeName = r.Form.Get("Committee_name")
	reservation.Phone = r.Form.Get("phone")
	reservation.Email = r.Form.Get("email")

	// reservation := models.Reservation{
	// 	FirstName:     r.Form.Get("first_name"),
	// 	CommitteeName: r.Form.Get("Committee_name"),
	...
	form.Required("first_name", "Committee_name", "email")
	...
	// log.Println("Reservation id -->", newreservationID)
...
func (m *Repository) PostAvailability(w http.ResponseWriter, r *http.Request) {
	...
	err := r.ParseForm()
	if err != nil {
		m.App.Session.Put(r.Context(), "errror", "cant parse start date")
		http.Redirect(w, r, "/", http.StatusTemporaryRedirect)
		return
	}
...
func (m *Repository) AdminPostShowReservation(w http.ResponseWriter, r *http.Request) {
	...
	res.CommitteeName = r.Form.Get("Committee_name")
