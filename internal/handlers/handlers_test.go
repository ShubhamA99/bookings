...
func TestRepository_PostReservation(t *testing.T) {
	...
	// reqBody = fmt.Sprintf("%s&%s", reqBody, "Committee_name=GOVBDP")
	...
	postedData.Add("first_name", "John Wick")
	postedData.Add("Committee_name", "Continental GOV")
	postedData.Add("email", "JW@killing.com")
	postedData.Add("phone", "205001010")
